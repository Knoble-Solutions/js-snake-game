...
//Declare global variable to track game board size
...
let gameBoardPixels = document.getElementsByClassName("gameBoardPixel")
...
const moveSnake = () => {
    ...
    // assuming an empty pixel, add snakee body styling
